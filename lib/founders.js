...
willing to help - even on short notice.”`,
  ...
  'Arnold Engel': {
    message: `“Rafael's been really great to work with. He's got a great
    perspective on the ecosystem, not just his perspective as an entrepreneur
    but having seen things from a couple different angles as a VC. He's super
    responsive and yet he's also out of the way when you don't really need him.”`,
    person: 'Arnold Engel',
    company: 'Tundra',
    link: 'https://www.tundra.com/',
    year: 2018,
    audio: '/static/audios/arnold-engel.m4a',
    picture: '/static/avatars/arnold-engel.jpeg',
    flags:['/static/flags/ca.svg', '/static/flags/us.svg']
  },
  'Michaël Villar': {
  ...
  "Matt O'Connor": {
    message: `“Rafael's help is pretty unique in the scheme of things because
    he's seen pretty much every angle: both operator, investor, larger investor,
    smaller investor, earlier stage, middle, late stage, so he has a lot of
    lenses and you can tell that by the way he gives advice and, you know,
    helps trouble shoot problems when things arise.”`,
    person: "Matt O'Connor",
    company: 'AdQuick',
    link: 'https://www.adquick.com/',
    year: 2018,
    audio: '/static/audios/matt-oconnor.m4a',
    picture: '/static/avatars/matthew-oconnor.jpg',
    flags:['/static/flags/us.svg', '/static/flags/ba.svg']
  },
  "Jon Katzur": {
    message: `“Rafael has added value to our company from our first conversation. 
    He's extremely responsive and is a great source of specific and actionable 
    feedback on everything from company culture to fundraising. He's also made a 
    number of useful introductions to prospects. We're thrilled to have him onboard.”`,
    person: "Jon Katzur",
    company: 'Stealth',
    link: 'https://www.adquick.com/',
    year: 2020,
    audio: '/static/audios/jon-katzur.m4a',
    picture: '/static/avatars/jon-katzur.jpg',
    flags:['/static/flags/us.svg', '/static/flags/bel.svg']
  },
  'Kendall Tucker': {
    message: `“Working with Rafael is awesome. He doesn't beat around the bush,
    helps you figure out what to do, inspires you to be the best that you can
    be, and is constantly teaching about entrepreneurship and fundraising.
    It's been a pleasure”`,
    person: 'Kendall Tucker',
    company: 'Polis',
    link: 'https://polisinc.com/',
    year: 2018,
    audio: '/static/audios/kendall-tucker.m4a',
    picture: '/static/avatars/kendall-tucker.png',
    flags:['/static/flags/us.svg', '/static/flags/en.svg']
  },
  'Jeremy Conrad': {
    message: `“Having Rafael as an investor at Quartz is one of the best
    decisions I've made so far. He's one of the most insightful people in
    the Valley and whenever I have a problem he can hop on a call with me,
    that day, and give me advice that I can't get from anyone else.”`,
    person: 'Jeremy Conrad',
    company: 'Quartz',
    link: 'https://www.quartz.co/',
    year: 2018,
    audio: '/static/audios/jeremy-conrad.m4a',
    picture: '/static/avatars/jeremy-conrad.jpg',
    flags:['/static/flags/us.svg', '/static/flags/ir.svg']
  }
}
