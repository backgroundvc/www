...
willing to help - even on short notice.”`,
  ...
  'Nilam Ganenthiran': {
    message: `“When I was starting Beacon Software, he was my first call. He helped me both vet the idea but most importantly inspired me to increase the scale of my ambitions about what Beacon could eventually become. I enthusiastically recommend Rafa to any founder who is looking for an unintrusive but in the details early stage partner.”`,
    person: 'Nilam Ganenthiran',
    company: 'Beacon Software',
    link: 'https://www.beaconsoftware.com/',
    year: 2024,
    audio: '/static/audios/nilam-ganenthiran.m4a',
    picture: '/static/avatars/nilam-ganenthiran.jpg',
    flags:['/static/flags/us.svg', '/static/flags/in.svg']
  },
  'Travis Hedge': {
  ...
  'Nish Khandwala': {
    message: `“Rafael was my first call. If you're a founder listening to this,
    just get him on your cap table. I can't overstate how wonderful of a partner
    Rafael has been. He's the kind that picks up your call on a Saturday morning,
    the kind of guy that advocates for you when you're not in the room. I've really
    appreciated his unwavering support and plus he's a really good operator so he's
    actually able to help you grow as a founder and a leader.”`,
    person: 'Nish Khandwala',
    company: 'Bunkerhill Health',
    link: 'https://www.bunkerhillhealth.com',
    year: 2022,
    audio: '/static/audios/nish-khandwala.m4a',
    picture: '/static/avatars/nish-khandwala.jpg',
    flags:['/static/flags/us.svg', '/static/flags/in.svg']
  },
  'Alek Koenig': {
  ...
  'Alex Klarfeld': {
    message: `“Rafael has been one of the most involved and genuinely helpful early
    stage investors I've worked with. He shows up more like a founder friend than 
    an investor, someone who is there for the wins but always there for the lows. 
    Having him in my corner has been some of the best support and cheerleading I've
    had as a founder.”`,
    person: 'Alex Klarfeld',
    company: 'Supergood',
    link: 'https://supergood.ai/',
    year: 2023,
    audio: '/static/audios/alex-klarfeld.m4a',
    picture: '/static/avatars/alex-klarfeld.jpg',
    flags:['/static/flags/us.svg']
  },
  'Aaron Nathan': {
    message: `“He turbocharged our entire fundraise process and saved me months of
    time by just digging in and doing the work. Years later, he still helps out with
    that same energy just when I need it and he's happy to be in the background
    when we're heads down.”`,
    person: 'Aaron Nathan',
    company: 'Point One',
    link: 'https://pointonenav.com/',
    year: 2021,
    audio: '/static/audios/aaron-nathan.m4a',
    picture: '/static/avatars/aaron-nathan.jpg',
    flags:['/static/flags/us.svg']
  },
  'Ori Konstantin': {
    message: `“I genuinely believe any founder would be lucky to have Rafael on 
    their side. He's not only always there for you and hyper responsive but 
    he gives you the honest feedback that pushes you to be better. Most importantly, 
    he has this unique ability to deliver even the toughest feedback in a way that's 
    genuinely positive and energizing. We couldn't have gotten our Seed done 
    without him.”`,
    person: 'Ori Konstantin',
    company: 'Lumopath',
    link: 'https://www.lumopath.ai/',
    year: 2022,
    audio: '/static/audios/ori-konstantin.m4a',
    picture: '/static/avatars/ori-konstantin.jpg',
    flags:['/static/flags/us.svg','/static/flags/is.svg','/static/flags/jp.svg']
  },
  'Daniel Demetri': {
